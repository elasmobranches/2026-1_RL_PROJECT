...
Step 3의 거리 관측·DQN·학습 설정을 포함한 최종 구성은 가장 가까운 미완료 레인을 선택하는 안정적인 정책을 학습했습니다. 연속 제어에서도 `nav_flags`와 관측 단순화를 포함한 최종 구성이 가장 높은 성능을 기록했습니다. Step 4 환경은 선택적 커리큘럼 기능을 지원하지만 최종 학습은 고정된 Level 2 시작 조건을 사용했으므로, 96.7% 성공률을 커리큘럼 효과로 해석할 수 없습니다. 각 변경의 독립적인 인과 효과는 추가 통제 실험이 필요합니다.
